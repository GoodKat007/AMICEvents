      ...
      <nav className="fixed top-0 left-0 right-0 bg-slate-900/80 backdrop-blur-xl border-b border-emerald-500/20 z-50 h-16">
        <div className="max-w-7xl mx-auto px-8 h-full flex items-center justify-between">
          ...
          <div className="flex items-center gap-8">
            ...
            <button className="bg-gradient-to-r from-blue-900 to-yellow-500 text-white border-none px-4 py-2 rounded-lg text-sm font-medium cursor-pointer hover:opacity-90 transition-opacity">
              Get Quote
            </button>
          </div>
        </div>
        ...
        <div className="max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          <div>
            ...
            <div className="flex gap-4 mb-8">
              <button className="bg-gradient-to-r from-blue-900 to-yellow-500 text-white border-none px-8 py-4 rounded-lg text-lg font-medium cursor-pointer hover:opacity-90 transition-opacity">
                START PROJECT
              </button>
              <button className="bg-transparent text-white border-2 border-emerald-500 px-8 py-3 rounded-lg text-lg font-medium cursor-pointer flex items-center gap-2 hover:bg-emerald-500/10 transition-colors">
                <svg
                  width="20"
                  height="20"
                  viewBox="0 0 24 24"
